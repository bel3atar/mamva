...
<html>
	...
	<body>
		<a href="#list-enquete" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-enquete" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${enqueteInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
